...
$toemails[] = array(
				'email' => 'reservastantasina@gmail.com', // Your Email Address
				'name' => 'Olga Arguello' // Your Name
			);
...
$fromemail = array(
				'email' => 'no-reply@xn--tantasia-j3a.com.ar', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Tantasi' . chr(0xf1) . 'a Suites' // Company Name
...
$recaptcha_secret = '6LcDxMAUAAAAANpDZ0SUzS6_sFaJozsMC2NyaYca'; // Your reCaptcha Secret
...
$message = array(
	'success'			=> 'Hemos recibido su mensaje y nos pondremos en contacto lo antes posible.',
	...
	'error_unexpected'	=> 'Un error inesperado ocurrió al enviar su mensaje. Por favor intente nuevamente.',
	'recaptcha_invalid'	=> 'Su Captcha no pudo ser validado. Por favor intente nuevamente.',
	'recaptcha_error'	=> 'Su Captcha no fue enviado! Por favor intente nuevamente.'
);
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$html_title	= !empty( $submits['html_title'] ) ? $submits['html_title'] : 'Reserva o Consulta';
	...
	$mail->Subject = !empty( $submits['subject'] ) ? $submits['subject'] : 'Formulario de reserva';
